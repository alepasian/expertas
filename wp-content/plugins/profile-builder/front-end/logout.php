<?php
    ...
    function wppb_front_end_logout( $atts ) {
        ...
        extract( shortcode_atts( array( 'text' => sprintf( __('Hola %s. ','profile-builder') ,$current_user->user_login) , 'redirect' => '', 'redirect_url' => wppb_curpageurl(), 'redirect_priority' => 'normal', 'link_text' => __('Log out &raquo;','profile-builder')), $atts ) );
